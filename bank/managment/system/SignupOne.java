...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        JLabel personaldetail = new JLabel("Page 1: Personal Detailed");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals(" ")){
                ...
                Conn c = new Conn();
                String query = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+DOB+"','"+gender+"','"+email+"','"+marital+"','"+city+"','"+address+"','"+pincode+"','"+state+"')";
